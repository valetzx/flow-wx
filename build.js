...
await fs.copyFile(path.join(__dirname, 'common.css'), path.join(outDir, 'common.css'));
await fs.copyFile(path.join(__dirname, 'common.js'), path.join(outDir, 'common.js'));
